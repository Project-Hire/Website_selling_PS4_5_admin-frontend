...
const CreateAdvertisement = () => {
  ...
  return (
    <PrivateLayout>
      <div className="advertisement-create">
        <div className="advertisement-create__title">Create Advertisement</div>
        <Form onFinish={onCreateAdvertisement} layout="vertical" className="advertisement-create__form">
          <Form.Item
            label="Name"
            name="name"
            rules={[{ required: true, message: 'Please input the name of advertisement!' }]}
          >
